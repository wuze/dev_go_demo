...
func main() {
	...
	bt := []byte("there was once a  physical therepyst, who travelled all the way from american to african to do a cencus about montain grillas ")
	sh := []byte("was")

	bl := bytes.Contains(bt, sh)
